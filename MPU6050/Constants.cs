namespace MPU6050
{
	public class Constants
	{
		...
		public const int DMPPacketSize = 42;

		public const byte MPU6050_ADDRESS_AD0_LOW = 0x68; // address pin low (GND), default for InvenSense evaluation board
		public const byte MPU6050_ADDRESS_AD0_HIGH = 0x69; // address pin high (VCC)
		...
		public const short MPU6050_DMP_MEMORY_BANK_SIZE = 256;
